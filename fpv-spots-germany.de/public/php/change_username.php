...
<head>
    ...
    <title>Benutzername ändern – FPV Spots Germany</title>
...
<?php include __DIR__ . '/../includes/header.php'; ?>
    ...
    <main class="container mt-5">
        ...
        <h1 class="h4">Benutzername ändern</h1>
        <p>Aktueller Benutzername: <span><b class="text-primary"><?= htmlspecialchars($username ?? '') ?></b></span></p>
        <form action="/private/php/data_changes/change_username_submit.php" method="post">
